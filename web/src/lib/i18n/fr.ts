...
export const fr: Catalog = {
	...
	game: {
		...
		hsModeArena: 'Arène',
		hsRatingNote:
			"La cote de Champs de bataille n'est pas inscrite dans les journaux du jeu. KFIRE mesure donc le niveau par la position moyenne et le taux de top 4, et affiche la cote des membres qui utilisent Hearthstone Deck Tracker.",
		hsRatingLink: 'Télécharger Hearthstone Deck Tracker',
		hsRating: 'Cote',
		hsRatingAt: 'au {date}',
		hsRatingCurve: 'Évolution de la cote',
		hsRatingCurveCaption: 'Cote après chacune des 20 dernières parties où Hearthstone Deck Tracker l’a enregistrée.',
		hsSortPlacement: 'Position moyenne',
		hsSortRating: 'Cote',
		hsSortBy: 'Trier par',

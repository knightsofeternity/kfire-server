...
export const en = {
	...
	game: {
		...
		hsModeArena: 'Arena',
		hsRatingNote:
			'Battlegrounds rating is not recorded in the game logs, so KFIRE measures skill by average placement and top-4 rate, and shows the rating of members who use Hearthstone Deck Tracker.',
		hsRatingLink: 'Get Hearthstone Deck Tracker',
		hsRating: 'Rating',
		hsRatingAt: 'as of {date}',
		hsRatingCurve: 'Rating over time',
		hsRatingCurveCaption: 'Rating after each of the last 20 matches Hearthstone Deck Tracker recorded.',
		hsSortPlacement: 'Avg. placement',
		hsSortRating: 'Rating',
		hsSortBy: 'Sort by',
